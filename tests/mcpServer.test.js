...
test("MCP server exposes Butler tools and can submit a goal", async () => {
  ...
  try {
    ...
    assert.ok(tools.tools.some((tool) => tool.name === "butler_replan_goal"));
    ...
    assert.ok(tools.tools.some((tool) => tool.name === "butler_add_current_butler_session"));
    ...
    assert.ok(tools.tools.some((tool) => tool.name === "butler_follow_session"));
    assert.ok(tools.tools.some((tool) => tool.name === "butler_advance_session_run"));
    assert.ok(tools.tools.some((tool) => tool.name === "butler_resume_session_run"));
